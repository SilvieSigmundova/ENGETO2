...
def test_scenario_prvni(page):
   ...
   mpsv.click()
   pageurl=page.url
   assert pageurl=='https://www.mpsv.cz/', "TEST1: Přesun na stránku MPSV se nezdařil."
...
def test_scenario_druhy(page):
   ...
   assert titulmpsv, "TEST2: Přesměrování na žádost MPSV neproběhla v pořádku."
...
def test_scenario_treti(page):
   ...
   if title_2 == "Kurzy programování a dalších IT technologií | ENGETO":
      print("TEST3: Titulek se shoduje.")
   else:
      print("TEST3: Titulek se neshoduje.")
   ...
   assert lekce, "TEST3: Seznam lekcí se nerozbalil."                         

   print("TEST3: Konec testu.")



def test_scenario_ctvrty(page):
   print("TEST4: Začátek testu.")
   cookies(page)
   ...
   if title_3 == "Kurzy programování s lektorem | Dotace až 50 000 Kč":
      print('TEST4: Stránka s přehledem kurzů se zobrazila.')
   else:
      print('TEST4: Stránka s přehledem kurzů se nezobrazila.')
   ...
   assert cenacelkem_1==cenacelkem_2,"TEST4: Cena celkem nesouhlasí."

   print("TEST4: Konec testu.")
   


def test_scenario_paty(page):
   print("TEST5: Začátek testu.")
   cookies(page)

   t5=page.get_by_role("link", name='Přehled IT kurzů')
   t5.click()

   t6=page.get_by_role("link", name='Tester s Pythonem Už jen')
   t6.click()
   
   t7=page.locator("text='Detail termínu'")
   t7.nth(0).click()

   t8=page.get_by_role("link", name='Objednat kurz')
   t8.click()
   ...
   if fo1==True and fo2==True:
      fo3=True
      print("TEST5: Jsou zobrazeny fakturační údaje pro fyzickou osobu.")
   ...
   if po1==True and po2==True:
      po3=True
      print("TEST5: Jsou zobrazeny fakturační údaje pro právnickou osobu.")
 
   assert (fo3==True and po3==True), "Fakturační údaje pro fyzickou a právnickou osobu se nezobrazily."

   print("TEST5: Konec testu.")
...
def test_nazvy_sekci(pageT,atribut,sekce):   
   ...
   assert (atrsek.count()>=1), (f"Sekce \"{sekce}\" kurzu Testing Akademie neexistuje.")